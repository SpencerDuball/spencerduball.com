...
import { IconButton, ScrollArea, ScrollViewport } from "~/ui";
...
const LinkItemClasses =
  "focus-outline text-slate-10 dark:text-slatedark-10 hover:text-slate-12 dark:hover:text-slatedark-12 hover:no-underline";

interface HeaderProps extends React.ComponentProps<"div"> {
  isAdmin: boolean;
}

function Header({ isAdmin, className, ...props }: HeaderProps) {
          ...
          <Nav.List className="grid list-none grid-flow-col gap-4">
            <Nav.Item asChild>
              <Nav.Link asChild>
                <Link
                  to="/"
                  className={cn(DesktopLinkClasses, /^\/$/.test(pathname) && "text-slate-12 dark:text-slatedark-12")}
                >
                  Home
                </Link>
              </Nav.Link>
            ...
            <Nav.Item asChild>
              <Nav.Link asChild>
                <Link
                  ...
                  className={cn(
                    DesktopLinkClasses,
                    /^\/blog\/?.*/.test(pathname) && "text-slate-12 dark:text-slatedark-12",
                  )}
                >
                  Blog
                </Link>
            ...
            <Nav.Item className="grid">
              <Nav.Trigger asChild>
                <button
                  className={cn(
                    DesktopLinkClasses,
                    /^\/projects\/?$/.test(pathname) && "text-slate-12 dark:text-slatedark-12",
                  )}
              ...
              <Nav.Content
                ...
                onPointerLeave={(e) => e.preventDefault()}
              >
                <div className="relative rounded-lg border border-slate-6 bg-slate-3 p-3 shadow-lg dark:border-slatedark-6 dark:bg-slatedark-3">
                  <div className="grid gap-2 rounded-lg bg-slate-4 p-4 dark:bg-slatedark-4">
                    <Nav.Link asChild>
                      <Link
                        to="/projects"
                        className={cn(
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <Nav.Link asChild>
                        <Link
                          ...
                          className={cn(
                            "focus-outline rounded-md bg-slate-6 p-2 text-center font-normal text-slate-10 hover:text-slate-12 hover:no-underline dark:bg-slatedark-6 dark:text-slatedark-10 dark:hover:text-slatedark-12",
                            /^\/projects\/software\/?.*/.test(pathname) &&
                              "bg-slate-7 font-semibold text-slate-12 dark:bg-slatedark-7 dark:text-slatedark-12",
                          )}
                        >
                          Software
                        </Link>
                      ...
                      <Nav.Link asChild>
                        <Link
                          ...
                          className={cn(
                            "focus-outline rounded-md bg-slate-6 p-2 text-center font-normal text-slate-10 hover:text-slate-12 hover:no-underline dark:bg-slatedark-6 dark:text-slatedark-10 dark:hover:text-slatedark-12",
                            /^\/projects\/3d-print\/?.*/.test(pathname) &&
                              "bg-slate-7 font-semibold text-slate-12 dark:bg-slatedark-7 dark:text-slatedark-12",
                          )}
                        >
                          3D Print
              ...
              <Nav.Item className="grid">
                <Nav.Trigger asChild>
                  <button
                    className={cn(
                      DesktopLinkClasses,
                      /^\/dashboard\/?.*$/.test(pathname) && "text-slate-12 dark:text-slatedark-12",
                    )}
                    onPointerMove={(e) => e.preventDefault()}
                    onPointerLeave={(e) => e.preventDefault()}
                  >
                ...
                <Nav.Content
                  ...
                  onPointerLeave={(e) => e.preventDefault()}
                >
                  <div className="relative grid gap-2 rounded-lg border border-slate-6 bg-slate-3 p-3 shadow-lg dark:border-slatedark-6 dark:bg-slatedark-3">
                    <div className="grid gap-2 rounded-lg bg-slate-4 p-4 dark:bg-slatedark-4">
                      <Nav.Link asChild>
                        <Link
                          to="/dashboard"
                    ...
                    <div className="grid gap-2 rounded-lg bg-slate-4 p-4 dark:bg-slatedark-4">
                      <Nav.Link asChild>
                        <Link
                          ...
                          className={cn(
                            LinkItemClasses,
                            /^\/dashboard\/analytics\/?.*/.test(pathname) && "text-slate-12 dark:text-slatedark-12",
                          )}
                        >
                    ...
                    <div className="grid gap-2 rounded-lg bg-slate-4 p-4 dark:bg-slatedark-4">
                      <Nav.Link asChild>
                        <Link
                          ...
                          className={cn(
                            LinkItemClasses,
                            /^\/dashboard\/cms\/?$/.test(pathname) && "text-slate-12 dark:text-slatedark-12",
                          )}
                        >
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <Nav.Link asChild>
                          <Link
                            ...
                            className={cn(
                              "focus-outline rounded-md bg-slate-6 p-2 text-center font-normal text-slate-10 hover:text-slate-12 hover:no-underline dark:bg-slatedark-6 dark:text-slatedark-10 dark:hover:text-slatedark-12",
                              /^\/dashboard\/cms\/blog\/?.*/.test(pathname) &&
                                "bg-slate-7 font-semibold text-slate-12 dark:bg-slatedark-7 dark:text-slatedark-12",
                            )}
                          >
                            Blog
        ...
        <Nav.Root delayDuration={100} className="relative md:hidden">
          <Nav.List className="list-none">
            <Nav.Item>
              ...
              <Nav.Content
                className="rounded-lg border border-slate-6 bg-slate-3 shadow-lg dark:border-slatedark-6 dark:bg-slatedark-3"
                onPointerMove={(e) => e.preventDefault()}
                onPointerLeave={(e) => e.preventDefault()}
              >
                      ...
                      <div className="grid gap-2 rounded-lg bg-slate-4 p-4 dark:bg-slatedark-4">
                        <Nav.Link asChild>
                          <Link
                            ...
                            className={cn(
                              LinkItemClasses,
                              /^\/$/.test(pathname) && "text-slate-12 dark:text-slatedark-12",
                            )}
                          >
                            <p className="font-semibold">Home</p>
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          ...
                          <Nav.Link asChild>
                            <Link
                              to="/projects/electronics"
                              className={cn(
                                "focus-outline rounded-md bg-slate-6 p-2 text-center font-normal text-slate-10 hover:text-slate-12 hover:no-underline dark:bg-slatedark-7 dark:text-slatedark-10 dark:hover:text-slatedark-12",
                                /^\/projects\/electronics\/?.*/.test(pathname) &&
                                  "bg-slate-7 font-semibold text-slate-12 dark:bg-slatedark-7 dark:text-slatedark-12",
                              )}
                            >
