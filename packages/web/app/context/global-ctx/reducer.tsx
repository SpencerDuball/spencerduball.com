...
export const ZGlobalCtxState = z.object({
  preferences: z.object({
    /** Tracks if the preferences have been restored on the client-side. */
    isRestored: z.boolean(),
    /** The theme on the client side can be "dark", "light", or "system". */
    theme: z.enum(["dark", "light", "system"]),
    /** The actual theme displayed on the page and save to cookie can be either "dark" or "light". */
...
export const reducer = (state: IGlobalCtxState, action: Actions): IGlobalCtxState => {
  switch (action.type) {
