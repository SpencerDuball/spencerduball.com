...
export const meta: MetaFunction = () => [
  ...
  { name: "description", content: "Manage your 3D print project posts." },
];
  ...
  return (
    <div className="grid w-full justify-items-center">
      <div className="w-full max-w-5xl px-4 py-6">
        {/* Title Card */}
        <div className="grid gap-4 rounded-lg bg-orange-5 p-4 shadow-md md:grid-flow-col md:p-6">
          <div className="grid gap-2">
            <h1 className="text-5xl font-extrabold leading-relaxed text-orange-11">3D Print</h1>
            <div className="flex flex-wrap items-center gap-3">
              ...
              <Link to="/dashboard/cms/3d-print" className="focus-outline font-bold leading-relaxed text-orange-12">
                3D Print
              </Link>
          ...
          <div className="grid w-full gap-2 justify-self-end rounded-lg bg-orange-3 px-4 py-5 shadow-sm md:w-64 md:px-6 md:py-6">
            <p className="text-slate-11">Prints</p>
